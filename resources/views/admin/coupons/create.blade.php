                    ...
                    <form action="{{ route('admin.coupons.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_unlimited" name="is_unlimited" value="1" {{ old('is_unlimited') ? 'checked' : '' }}>
                                <label class="custom-control-label" for="is_unlimited">Unlimited Usage</label>
                            </div>
                        </div>

                        <div class="form-group usage-limit-group" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('couponable_type') is-invalid @enderror" id="couponable_type" name="couponable_type" required>
                                ...
                                <option value="App\Models\Market" {{ old('couponable_type') == 'App\Models\Market' ? 'selected' : '' }}>Market</option>
                                <option value="App\Models\Branch" {{ old('couponable_type') == 'App\Models\Branch' ? 'selected' : '' }}>Branch</option>
                            </select>
                        ...
                        <div class="form-group market-select-group" style="display: none;">
                        ...
                        <div class="form-group">
                            <label for="couponable_id">Select {{ old('couponable_type') == 'App\Models\Market' ? 'Market' : 'Branch' }}</label>
                            <select class="form-control @error('couponable_id') is-invalid @enderror" id="couponable_id" name="couponable_id" required>
                                <option value="">Select {{ old('couponable_type') == 'App\Models\Market' ? 'Market' : 'Branch' }}</option>
                            </select>
                            @error('couponable_id')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
