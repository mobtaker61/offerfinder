            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <div class="image-preview mb-3" style="width: 100%; max-width: 300px; display: none;">
                        ...
                        <div class="d-flex gap-2 w-100">
                            ...
                            <button type="button" class="btn btn-outline-danger" id="removeImage" style="display: none;">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('scope') is-invalid @enderror" id="scope" name="scope" required>
                        <option value="global" {{ old('scope') == 'global' ? 'selected' : '' }}>Global (All Users)</option>
                        <option value="market" {{ old('scope') == 'market' ? 'selected' : '' }}>Specific Market</option>
                        <option value="branch" {{ old('scope') == 'branch' ? 'selected' : '' }}>Specific Branch</option>
                    </select>
                    @error('scope')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
...
<script>
    $(document).ready(function() {
        ...
        // Trigger scope change on page load if there's a selected value
        if ($('#scope').val()) {
