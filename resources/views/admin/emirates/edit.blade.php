    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3 mb-0 text-gray-800">Edit Emirate</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.emirates.update', $emirate) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div id="map" 
                                ...
                                data-lat="{{ old('latitude', $emirate->latitude) }}"
                                data-lng="{{ old('longitude', $emirate->longitude) }}">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="number" 
