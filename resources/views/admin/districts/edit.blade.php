                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div id="map" 
                                ...
                                data-lat="{{ old('latitude', $district->latitude) }}"
                                data-lng="{{ old('longitude', $district->longitude) }}">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="number" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="boundary_coordinates" 
                                ...
                                rows="3">{{ old('boundary_coordinates', json_encode($district->boundary_coordinates, JSON_PRETTY_PRINT)) }}</textarea>
