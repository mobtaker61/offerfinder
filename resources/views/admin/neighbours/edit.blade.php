...
@section('title', 'Edit Neighbour')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Neighbour</h1>
        <a href="{{ route('admin.neighbours.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Back to Neighbours
        </a>
    </div>

    <div class="card-body" data-districts='@json($districts)' data-old-district='{{ old('district_id', $neighbour->district_id) }}'>
        <form action="{{ route('admin.neighbours.update', $neighbour) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            id="local_name"
                            name="local_name"
                            value="{{ old('local_name', $neighbour->local_name) }}">
                        @error('local_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('emirate_id') is-invalid @enderror"
                            ...
                            <option value="{{ $emirate->id }}" {{ old('emirate_id', $neighbour->district->emirate_id) == $emirate->id ? 'selected' : '' }}>
                                {{ $emirate->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url"
                            ...
                            id="info_link"
                            name="info_link"
                            value="{{ old('info_link', $neighbour->info_link) }}"
                            placeholder="https://">
                        @error('info_link')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                            id="description"
                            name="description"
                            rows="3">{{ old('description', $neighbour->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox"
                                ...
                                name="is_active"
                                value="1"
                                {{ old('is_active', $neighbour->is_active) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="map"
                            ...
                            data-lat="{{ old('latitude', $neighbour->latitude ?? '25.2048') }}"
                            data-lng="{{ old('longitude', $neighbour->longitude ?? '55.2708') }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="boundary_coordinates" class="form-control @error('boundary_coordinates') is-invalid @enderror" rows="3">{{ old('boundary_coordinates', $neighbour->boundary_coordinates) }}</textarea>
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Update Neighbour
                </button>
            </div>
        </form>
    </div>
